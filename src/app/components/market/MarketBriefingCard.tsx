...
export function MarketBriefingCard() {
  ...
  if (loading) {
    return (
      <Card className="w-full lg:w-1/4 p-4 bg-slate-700 border-slate-600 animate-pulse">
  ...
  return (
    ...
    <Card className="w-full lg:w-1/4 overflow-hidden bg-slate-700 border-slate-600">
      {/* 그라데이션 헤더 */}
